...
~:$ wget -q http://redis.googlecode.com/files/redis-2.6.9.tar.gz  #A
~:$ tar -xzf redis-2.6.2.tar.gz                            #B
~:$ cd redis-2.6.9/
~/redis-2.6.9:$ make                                    #C
cd src && make all                                          #D
[trimmed]                                                   #D
make[1]: Leaving directory `~/redis-2.6.9/src'          #D
~/redis-2.6.9:$ sudo make install                       #E
cd src && make install                                      #F
[trimmed]                                                   #F
make[1]: Leaving directory `~/redis-2.6.9/src'          #F
~/redis-2.6.9:$ redis-server redis.conf                             #G
[13792] 2 Feb 17:53:16.523 * Max number of open files set to 10032  #H
[trimmed]                                                           #H
[13792] 2 Feb 17:53:16.529 * The server is now ready to accept      #H
...
Downloading rudix.googlecode.com/files/rudix-12.10-0.pkg            #C
[trimmed]                                                           #C
installer: The install was successful.                              #C
All done                                                            #C
~:$ sudo rudix install redis                                        #D
Downloading rudix.googlecode.com/files/redis-2.6.9-0.pkg            #E
[trimmed]                                                           #E
installer: The install was successful.                              #E
All done                                                            #E
~:$ redis-server                                                    #F
[699] 6 Feb 21:18:09 # Warning: no config file specified, using the #G
default config. In order to specify a config file use 'redis-server #G
/path/to/redis.conf'                                                #G
[699] 6 Feb 21:18:09 * Server started, Redis version 2.6.9          #G
[699] 6 Feb 21:18:09 * The server is now ready to accept connections#G
on port 6379                                                        #G
[699] 6 Feb 21:18:09 - 0 clients connected (0 slaves), 922304 bytes #G
in use                                                              #G
...
#E Rudix is downloading and installing Redis
